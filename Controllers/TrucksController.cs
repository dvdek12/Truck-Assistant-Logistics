...
namespace TruckAssistant.Controllers
{
    public class TrucksController : Controller
    {
        ...
        public TrucksController(TruckAssistantContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Brand,Vmax,DriverBreaksLength, DriverBreaksInterval")] Truck truck)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Brand,Vmax,DriverBreaksLength, DriverBreaksInterval")] Truck truck)
        {
            if (id != truck.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TruckAssistantContext.Truck'  is null.");
            }
            var truck = await _context.Truck.FindAsync(id);
            if (truck != null)
            {
